...
// import { payment } from '../../../server/mongo';
 ...
 const handlebid = async(e)=>{
  if(searchquant){
    const data = {
      ...
      product:search?search:e.target.closest('.milldatas').querySelector('.productname').innerText,
     quantity:searchquant,
      ...
      clientphone: userdet.loogedin.phone ? userdet.loogedin.phone  : 'Contact details not provided',
